# Tooltip for Angular
### forked from cloudfactorydk/ng2-tooltip-directive
...
Install the npm package.
    ...
    npm i @logscl/ng2-tooltip-directive
        
Import `Ng2Module`:

```ts
import { TooltipModule } from '@logscl/ng2-tooltip-directive';
...
```ts
import { TooltipOptions } from '@logscl/ng2-tooltip-directive';
...
```ts
import { TooltipModule, TooltipOptions } from '@logscl/ng2-tooltip-directive';
